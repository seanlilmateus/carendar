  ...
  class PreferencesViewController < BaseViewController
    ...
    def update_view_constraints
      ...
      NSLayoutConstraint.activateConstraints([
        toke_field.widthAnchor
                  .constraintEqualToAnchor(self.view.widthAnchor, constant: - 40),
        toke_field.centerXAnchor
                  .constraintEqualToAnchor(self.view.centerXAnchor),
        toke_field.topAnchor
                  .constraintEqualToAnchor(self.view.topAnchor, constant: 15),
        ...
        box1.topAnchor
            .constraintEqualToAnchor(toke_field.bottomAnchor, constant: 20),
        box1.heightAnchor
            .constraintEqualToAnchor(self.view.heightAnchor, multiplier: 0.30),
        ...
        restart_switcher.topAnchor
                        .constraintEqualToAnchor(box2.bottomAnchor, constant: 12),
        restart_switcher.leftAnchor.constraintEqualToAnchor(box2.leftAnchor),
        restart_label.topAnchor
                     .constraintEqualToAnchor(box2.bottomAnchor, constant: 12),
        restart_label.leftAnchor
                     .constraintEqualToAnchor(restart_switcher.rightAnchor, constant: 12),
      ])
    end
    ...
    def positioning(items)
      ...
      NSLayoutConstraint.activateConstraints([
        label0.widthAnchor
              .constraintEqualToAnchor(label0.superview.widthAnchor, multiplier: 1.0/4.0),
        ...
        label1.widthAnchor
              .constraintEqualToAnchor(label1.superview.widthAnchor, multiplier: 1.0/4.0),
